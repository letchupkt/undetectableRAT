...
while True:
    try:
        hshfasudf = "XEYSRGFAVHLIXHFLAOUTX23ZTAXSXHFBZIPGXAFHYOFR4HFUZA3IVZPSBIWUFZY2ZAHGPEFZAAQUFGXIUSRSVEGUB5WHDDYLZIYSXZ2CVHLUVMQXWVLSTIXFB5TSZ2QFZIZR26GQAIYUPGXSZEXITEX2BV======"
        ...
        @bot.event
        async def on_ready():
            print("undetectable minimal is ready")
